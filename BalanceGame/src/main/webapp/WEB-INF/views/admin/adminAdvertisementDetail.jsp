...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  $(function () {
	...
	$(document).ready(function(){
	    ...
	    var advertisementStatus = "${adData.advertisementStatus}";
	    var advertisementId = "${adData.advertisementId}";
	    if (advertisementStatus === "T") {
	    ...
	    $('#customSwitch').change(function(){
	        if($(this).is(':checked')) {
	        	...
	        	showSuccess("상태","광고 숨김");
	            adShowAndHide(advertisementId, advertisementStatus)
	            // 여기에 체크가 해제되었을 때의 추가적인 작업을 할 수 있습니다.
	        }
	    });
	});
	
	function adShowAndHide(advertisementId, advertisementStatus) {
		$.ajax({
			type: "POST",
			url: "/admin/advertisementStatusAsync",
