...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<a href="/admin/adminPage" class="brand-link"> <img
				src="images/logo.png" alt="자비스로고"
								...
								<div class="card-body">
									<div class="form-group">
										<label for="inputName">제목</label> <input type="text"
											...
											value="${questionData.title}" name="title">
									</div>
									<div class="form-group">
										...
										<input type="hidden" value="${questionData.answerAImg}" name="answerAImg">
										<input type="hidden" value="F" name="retouch" id="chooseFileARetouch">
									...
									<div class="form-group">
										...
										<input type="hidden" value="${questionData.answerBImg}" name="answerBImg">
