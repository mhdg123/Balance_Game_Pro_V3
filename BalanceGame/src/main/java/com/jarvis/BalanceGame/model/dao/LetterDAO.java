...
public class LetterDAO {
	...
	// 안읽은 편지 조회
	private static final String SELECTALL_UNREAD = "SELECT LETTER_ID, TITLE, SENDER, LETTER_STATUS, LETTER_DATE FROM LETTER WHERE LETTER_STATUS = 'F' AND LOGIN_ID=? ORDER BY LETTER_ID DESC";
