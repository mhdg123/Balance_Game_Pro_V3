...
public class AdminQuestionManagementPageController {
	...
	public String adminTitleManagementPageController(QuestionDTO qDTO, PageInfoDTO pDTO, Model model,HttpSession session) {
		...
		pDTO.setSearchCondition("adminViewAllOfApprovedQuestions");
