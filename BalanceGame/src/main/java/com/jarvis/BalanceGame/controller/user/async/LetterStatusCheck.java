...
//    public @ResponseBody String letterCheckUnRead(@RequestParam("letterCheck") List<String> letterCheck ,
...
//    public @ResponseBody String letterCheckRead(@RequestParam("letterCheck") List<String> letterCheck ,
//    		LetterDTO lDTO, HttpSession session,  Gson gson) {
//    	// jsp에서 
//        // 세션에서 로그인 ID 가져오기
//        String loginId = (String)session.getAttribute("loginId");
...
//    public @ResponseBody String letterCheckDelete(@RequestParam("letterCheck") List<String> letterCheck ,
//    		LetterDTO lDTO, HttpSession session,  Gson gson) {
//    	// jsp에서 
//        // 세션에서 로그인 ID 가져오기
//        String loginId = (String)session.getAttribute("loginId");
